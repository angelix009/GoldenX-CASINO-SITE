...
<div class="row">
    <div class="col-xl-4">
      ...
      <div class="row">
        ...
        <div class="col-6"><button class="btn btn-danger w-100" type="button" onclick="deleteUser({{$user->id}})">Delete аккаунт</button></div>
    </div>
...
<div class="col-md-6">
  <div class="card">
    <div class="card-header">
      <h4 class="card-title mb-0">Withdrawы</h4>
      <div class="card-options"><a class="card-options-collapse" href="#" data-bs-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a><a class="card-options-remove" href="#" data-bs-toggle="card-remove"><i class="fe fe-x"></i></a></div>
  </div>
  <div class="table-responsive add-project">
...
<div class="col-md-12">
  <div class="card">
    <div class="card-header">
      <h4 class="card-title mb-0">History баланса</h4>
      <div class="card-options"><a class="card-options-collapse" href="#" data-bs-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a><a class="card-options-remove" href="#" data-bs-toggle="card-remove"><i class="fe fe-x"></i></a></div>
  </div>
  <div class="table-responsive add-project">
      ...
      <table class="table "  style="margin-bottom: 20px;"> 
        ...
        <thead>
            <tr>
                ...
                <th scope="col">Balance до</th>
                <th scope="col">Balance после</th>
