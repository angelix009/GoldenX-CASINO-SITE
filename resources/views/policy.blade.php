<div class="wrapper">
                <div style="margin-top: 20px" class="text">
                    <div class="text__content">
                        ...
                        <p>3.2. В целях предотвращения случайного удаления или повреждения данных информация хранится в резервных копиях в течение 7 days и может быть восстановлена по запросу пользователя.</p>
                        <div class="text__borders"></div>
                        <h3>4. Предоставление данных третьим лицам</h3>
                        <p>4.1. Личные данные пользователей могут быть переданы лицам, не связанным с настоящим сайтом, если это необmoveимо:</p>
                        ...
                        <p>4.2. В случае продажи настоящего сайта пользователи должны быть уведомлены об этом не позднее чем за 10 days до совершения сделки.</p>
                        <div class="text__borders"></div>
